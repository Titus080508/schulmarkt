  ...
  return (
    <div style={{ minHeight: '100vh', background: 'var(--bg-page)', padding: '40px 20px' }}>
      <div style={{ maxWidth: '700px', margin: '0 auto', background: 'var(--bg-card)', border: '1px solid var(--border-color)', borderRadius: '10px', padding: '36px' }}>
        <h1 style={{ fontSize: '22px', fontWeight: 600, color: 'var(--color-primary)', marginBottom: '24px' }}>Nutzungsbedingungen</h1>
        ...
        <p style={{ fontSize: '14px', color: 'var(--text-secondary)', lineHeight: 1.7 }}>
          ...
          <Link href="/datenschutz" className="link-modern" style={{ color: 'var(--color-primary)' }}>Datenschutzerklärung</Link>.
        </p>
