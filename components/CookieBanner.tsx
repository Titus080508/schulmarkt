...
export default function CookieBanner() {
  ...
  return (
    <div style={{
      ...
      background: 'var(--color-primary)', color: 'var(--text-on-dark)', padding: '16px 20px',
      ...
      <p style={{ fontSize: '13px', margin: 0, maxWidth: '600px', lineHeight: 1.6 }}>
        ...
        <Link href="/datenschutz" style={{ color: 'var(--color-accent-on-dark)', textDecoration: 'underline' }}>Datenschutzerklärung</Link>.
      </p>
      <button onClick={dismiss} style={{
        background: 'var(--color-accent)', color: 'var(--text-on-dark)', border: 'none', borderRadius: '6px',
